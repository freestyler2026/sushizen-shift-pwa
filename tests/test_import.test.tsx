...
// Static import — avoids the jsdom/Proxy mock collection-phase hang
import OvertimeTab from "@/app/admin/analytics/OvertimeTab";

describe("Static import test", () => {
  it("imports OvertimeTab", () => {
    expect(OvertimeTab).toBeDefined();
  });

  it("renders OvertimeTab without crashing", async () => {
    render(
      <OvertimeTab city="dubai" dateFrom="2026-05-01" dateTo="2026-05-31" approverName="Jay" pin="1234" />,
    );
