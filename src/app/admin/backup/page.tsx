...
const DUBAI_TEMPLATE_SECTIONS: TemplateSection[] = [
  {
    ...
    items: [
      { key: "ginger",     label: "Ginger",     unit: "pcs", section: "supplies", item_type: "ingredient", item_category: "Vegetables" },
      { key: "wasabi",     label: "Wasabi",     unit: "pcs", section: "supplies", item_type: "ingredient", item_category: "Seasonings" },
      { key: "soy_sauce",  label: "Soy Sauce",  unit: "pcs", section: "supplies", item_type: "ingredient", item_category: "Seasonings" },
      { key: "sweet_sauce",label: "Sweet Sauce",unit: "pcs", section: "supplies", item_type: "menu_item",  item_category: "Original Sushi Sauce" },
      { key: "miso_soup",  label: "Miso Soup",  unit: "pcs", section: "supplies", item_type: "menu_item",  item_category: "Hot Menu Cost" },
      { key: "ice_pack",   label: "Ice Pack",   unit: "pcs", section: "supplies", item_type: "ingredient", item_category: "Packaging" },
    ],
  },
  {
    id: "packaging",
    label: "Packaging",
    items: [
      { key: "box_12",      label: "NEW BOX 12",    unit: "pcs", section: "packaging", item_type: "ingredient", item_category: "Packaging" },
      { key: "box_16",      label: "NEW BOX 16",    unit: "pcs", section: "packaging", item_type: "ingredient", item_category: "Packaging" },
      { key: "box_24",      label: "NEW BOX 24",    unit: "pcs", section: "packaging", item_type: "ingredient", item_category: "Packaging" },
      { key: "roll_box_1",  label: "1-Roll Box",    unit: "pcs", section: "packaging", item_type: "ingredient", item_category: "Packaging" },
      { key: "roll_box_2",  label: "2-Roll Box",    unit: "pcs", section: "packaging", item_type: "ingredient", item_category: "Packaging" },
      { key: "temaki_box",  label: "Temaki Box",    unit: "pcs", section: "packaging", item_type: "menu_item",  item_category: "Packaging" },
      { key: "momo_box",    label: "Momo Box",      unit: "pcs", section: "packaging", item_type: "ingredient", item_category: "Packaging" },
      { key: "cutlery_1",   label: "Cutlery Set 1", unit: "set", section: "packaging", item_type: "ingredient", item_category: "Packaging" },
      { key: "cutlery_2",   label: "Cutlery Set 2", unit: "set", section: "packaging", item_type: "ingredient", item_category: "Packaging" },
      { key: "cutlery_4",   label: "Cutlery Set 4", unit: "set", section: "packaging", item_type: "ingredient", item_category: "Packaging" },
      { key: "chopsticks",  label: "Chopsticks",    unit: "pcs", section: "packaging", item_type: "ingredient", item_category: "Packaging" },
    ],
  },
  {
    id: "prep",
    ...
    items: [
      ...
      { key: "crabstick_top",    label: "Topping Crab Sticks",       unit: "container", section: "prep", item_type: "ingredient", item_category: "Processed Meat / Eggs" },
      { key: "dumplings",        label: "Chicken Dumplings",         unit: "tray",      section: "prep", item_type: "menu_item",  item_category: "CK Processed" },
      { key: "teriyaki_chicken", label: "Teriyaki Chicken",          unit: "kg",        section: "prep", item_type: "menu_item",  item_category: "Processed Ingredients Cost" },
      { key: "beef_marinated",   label: "Beef Marinated",            unit: "pcs",       section: "prep", item_type: "menu_item",  item_category: "Processed Ingredients" },
      { key: "fried_chicken",    label: "Fried Chicken",             unit: "kg",        section: "prep", item_type: "menu_item",  item_category: "CK Processed" },
      { key: "stretched_shrimp", label: "Stretched Shrimp",          unit: "tray",      section: "prep", item_type: "ingredient", item_category: "Fresh Fish" },
      ...
      { key: "french_fries",     label: "French Fries",              unit: "pcs",       section: "prep", item_type: "ingredient", item_category: "Vegetables" },
    ],
  },
  {
    id: "toppings",
    ...
    items: [
      { key: "chips_oman",  label: "Chips Oman",              unit: "container", section: "toppings", item_type: "ingredient", item_category: "Dry Goods / Other" },
      { key: "tf_white",    label: "Tempura Flakes (White)",  unit: "container", section: "toppings", item_type: "menu_item",  item_category: "CK Processed" },
      { key: "tf_orange",   label: "Tempura Flakes (Orange)", unit: "container", section: "toppings", item_type: "menu_item",  item_category: "CK Processed" },
      { key: "tf_yellow",   label: "Tempura Flakes (Yellow)", unit: "container", section: "toppings", item_type: "menu_item",  item_category: "Processed Products" },
      { key: "tf_green",    label: "Tempura Flakes (Green)",  unit: "container", section: "toppings", item_type: "menu_item",  item_category: "Processed Products" },
    ],
  },
  {
    id: "rolls",
    ...
    items: [
      ...
      { key: "dynamite",          label: "Dynamite Shrimp Roll",  unit: "pcs", section: "rolls", item_type: "menu_item", item_category: "Sushi Rolls" },
      ...
      { key: "salmon_hosomaki",   label: "Salmon Hosomaki",       unit: "pcs", section: "rolls", item_type: "menu_item", item_category: "Nigiri & Sashimi" },
      { key: "cucumber_hosomaki", label: "Cucumber Hosomaki",     unit: "pcs", section: "rolls", item_type: "menu_item", item_category: "Nigiri & Sashimi" },
      { key: "tuna_hosomaki",     label: "Tuna Hosomaki",         unit: "pcs", section: "rolls", item_type: "menu_item", item_category: "Nigiri & Sashimi" },
    ],
  },
];
...
const MANILA_TEMPLATE_SECTIONS: TemplateSection[] = [
  {
    ...
    label: "Condiments & Supplies",
    items: [
      { key: "m_soy_sauce",       label: "Soy Sauce",                  unit: "pcs", section: "supplies", item_type: "ingredient", item_category: "Seasonings" },
      { key: "m_wasabi",          label: "Wasabi",                     unit: "pcs", section: "supplies", item_type: "ingredient", item_category: "Seasonings" },
      { key: "m_ginger",          label: "Ginger",                     unit: "pcs", section: "supplies", item_type: "ingredient", item_category: "Vegetables" },
      { key: "m_swg_set",         label: "Soy Sauce, Wasabi, Ginger Set", unit: "set", section: "supplies", item_type: "ingredient", item_category: "Seasonings" },
      { key: "m_miso_soup",       label: "Miso Soup",                  unit: "pcs", section: "supplies", item_type: "menu_item",  item_category: "Hot Menu Cost" },
      { key: "m_sweet_sauce",     label: "Sweet Sauce",                unit: "pcs", section: "supplies", item_type: "menu_item",  item_category: "Original Sushi Sauce" },
      { key: "m_dumpling_sauce",  label: "Dumpling Sauce",             unit: "pcs", section: "supplies", item_type: "ingredient", item_category: "Seasonings" },
    ],
  },
  {
    id: "packaging",
    label: "Packaging",
    items: [
      { key: "m_ice_pack",  label: "Ice Pack",  unit: "pcs", section: "packaging", item_type: "ingredient", item_category: "Packaging" },
      { key: "m_box_12",    label: "Box12 Set", unit: "pcs", section: "packaging", item_type: "ingredient", item_category: "Packaging" },
      { key: "m_box_16",    label: "Box16 Set", unit: "pcs", section: "packaging", item_type: "ingredient", item_category: "Packaging" },
      { key: "m_box_24",    label: "Box24 Set", unit: "pcs", section: "packaging", item_type: "ingredient", item_category: "Packaging" },
    ],
  },
  {
    id: "prep",
  ...
  },
  {
    ...
    label: "Toppings & Flakes",
    items: [
      { key: "m_spring_onion_top",   label: "Spring Onion",                unit: "container", section: "toppings", item_type: "ingredient", item_category: "Vegetables" },
      ...
      { key: "m_cheese_dice",        label: "Cheese Dice Cut",             unit: "container", section: "toppings", item_type: "ingredient", item_category: "Seasonings" },
      { key: "m_mango_cube",         label: "Mango Cube",                  unit: "container", section: "toppings", item_type: "ingredient", item_category: "Vegetables" },
      ...
      { key: "m_red_chili",          label: "Red Chili Cut",               unit: "container", section: "toppings", item_type: "ingredient", item_category: "Vegetables" },
      { key: "m_mint_leaves",        label: "Mint Leaves",                 unit: "container", section: "toppings", item_type: "ingredient", item_category: "Vegetables" },
      { key: "m_onion_leeks",        label: "Onion Leeks",                 unit: "container", section: "toppings", item_type: "ingredient", item_category: "Vegetables" },
      { key: "m_tf_white",           label: "Tempura Flakes White",        unit: "container", section: "toppings", item_type: "menu_item",  item_category: "CK Processed" },
      { key: "m_tf_orange",          label: "Tempura Flakes Orange",       unit: "container", section: "toppings", item_type: "menu_item",  item_category: "CK Processed" },
      { key: "m_tf_red",             label: "Tempura Flakes Red",          unit: "container", section: "toppings", item_type: "menu_item",  item_category: "CK Processed" },
      { key: "m_tf_yellow",          label: "Tempura Flakes Yellow",       unit: "container", section: "toppings", item_type: "menu_item",  item_category: "Processed Products" },
      { key: "m_tf_pink",            label: "Tempura Flakes Pink",         unit: "container", section: "toppings", item_type: "menu_item",  item_category: "Processed Products" },
      { key: "m_fried_dumplings",    label: "Fried Dumplings",             unit: "container", section: "toppings", item_type: "menu_item",  item_category: "CK Processed" },
      { key: "m_shichimi",           label: "Shichimi Powder",             unit: "container", section: "toppings", item_type: "ingredient", item_category: "Seasonings" },
      { key: "m_all_sauces",         label: "All Sauces",                  unit: "container", section: "toppings", item_type: "ingredient", item_category: "Seasonings" },
    ],
  },
  {
    id: "hot_section",
    label: "Hot Section",
    items: [
      { key: "m_spring_onion_hot",   label: "Spring Onion",               unit: "container", section: "hot_section", item_type: "ingredient", item_category: "Vegetables" },
      ...
      { key: "m_sliced_onion",       label: "Sliced Onion",               unit: "container", section: "hot_section", item_type: "ingredient", item_category: "Vegetables" },
      { key: "m_bok_choy",           label: "Bok Choy",                   unit: "container", section: "hot_section", item_type: "ingredient", item_category: "Vegetables" },
      { key: "m_bamboo_shoot",       label: "Bamboo Shoot",               unit: "container", section: "hot_section", item_type: "ingredient", item_category: "Dry Goods / Other" },
      { key: "m_sweet_corn",         label: "Sweet Corn",                 unit: "container", section: "hot_section", item_type: "ingredient", item_category: "Vegetables" },
      ...
      { key: "m_shredded_cabbage",   label: "Shredded Cabbage for Bento", unit: "container", section: "hot_section", item_type: "ingredient", item_category: "Vegetables" },
      { key: "m_chopped_leeks",      label: "Chopped Leeks",              unit: "container", section: "hot_section", item_type: "ingredient", item_category: "Vegetables" },
      { key: "m_baguio_beans",       label: "Baguio Beans",               unit: "container", section: "hot_section", item_type: "ingredient", item_category: "Vegetables" },
      { key: "m_benishoga",          label: "Benishoga (Red Ginger)",     unit: "container", section: "hot_section", item_type: "ingredient", item_category: "Seasonings" },
      { key: "m_wakame",             label: "Wakame",                     unit: "container", section: "hot_section", item_type: "ingredient", item_category: "Dry Goods / Other" },
    ],
  },
  {
    id: "base_roll",
