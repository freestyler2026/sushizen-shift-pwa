    ...
    <div className="space-y-6">
      ...
      <section className="rounded-2xl border border-neutral-800 bg-neutral-900/20 p-5">
        ...
        <div className="mt-4 rounded-2xl border border-neutral-800 bg-neutral-950/20 p-4">
          ...
          <div className="mt-1 text-xs text-neutral-200">Use <span className="text-amber-400 font-medium">ITEM</span> for raw ingredients and <span className="text-amber-400 font-medium">PRODUCT</span> for CK-made items.</div>
