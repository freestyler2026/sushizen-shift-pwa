...
const TR = {
  ...
  ja: {
    pageTitle: "Daily Operations Report",
    subtitle: "All data · Fetches latest data on every open · Auto-generated daily at 13:30 PHT (previous day)",
    refresh: "Refresh", generateNow: "Force Regenerate", generating: "Generating...",
    reportDate: "Date", generatedAt: "Generated",
    noReports: "No report for today yet.", noReportsHint: "HQ/ADMIN can generate one manually using Generate Now.",
    accessDenied: "Analytics permission required.",
    generateConfirm: "Generate the report for {city} now?",
    errorPrefix: "Error",
    sec_overview: "Daily Summary",
    sec_branch: "By Branch",
    sec_sales: "Sales Detail",
    sec_attendance: "Attendance Detail",
    sec_adherence: "Shift Adherence",
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button onClick={() => setLang(l => l==="en"?"ja":"en")}
              ...
              <Globe className="h-3.5 w-3.5" />{lang==="en"?"JA":"EN"}
            </button>
