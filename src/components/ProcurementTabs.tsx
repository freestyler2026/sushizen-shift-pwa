...
const GROUPS: TabGroup[] = [
  {
    ...
    tabs: [
      ...
      { href: "/admin/procurement/order-grid",       label: "Order Grid",        showTo: ["staff", "manager", "inventory", "full"] },
      { href: "/admin/procurement/ck-wh-grid",      label: "CK/WH Grid",        showTo: ["manager", "full"] },
  ...
  },
  {
    ...
    tabs: [
      ...
      { href: "/admin/procurement/delivery-schedule",    label: "Delivery Schedule",   showTo: ["full"] },
      { href: "/admin/procurement/delivery-addresses",   label: "Branch Addresses",    showTo: ["full"] },
