...
export default function LayoutShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      */}
      <header
        className="sticky top-0 z-50 overflow-x-hidden border-b border-white/10 bg-[#0d1117] backdrop-blur-xl md:hidden"
      ...
      {/* pb accounts for the fixed mobile bottom nav plus home indicator safe area; md:pb-6 removes it on desktop */}
      <main
        className="mx-auto max-w-6xl px-4 py-4 sm:px-6 sm:py-6 md:mx-0 md:ml-60 md:max-w-none md:px-8 md:pb-6"
