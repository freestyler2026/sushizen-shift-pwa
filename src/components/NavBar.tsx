...
const ADMIN_ITEMS: NavItem[] = [
  ...
  { href: "/admin/notice-to-explain", label: "Notice to Explain", icon: FileText, adminOnly: true, match: "prefix" },
...
export default function NavBar() {
  ...
  function canSeeAdminItem(href: string, auth: ReturnType<typeof getAuth>) {
    ...
    if (href === "/admin/notice-to-explain") return ["HQ", "ADMIN", "HR_MANAGER", "MANILA_MANAGEMENT", "MANILA_MANAGER"].includes(role);
