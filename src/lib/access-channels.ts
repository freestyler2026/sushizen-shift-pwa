...
export const CHANNEL_ROUTES: ReadonlyArray<readonly [string, ChannelRoute]> = [
  ...
  ["/admin/aggregator-price-monitor", { channel: "admin.aggregator_price_monitor", match: "prefix", admin: true }],
  ...
  ["/admin/help", { channel: "admin.help", match: "prefix", admin: true }],
  ...
  ["/admin/hr/today", { channel: "admin.hr_today", match: "prefix", admin: true }],
  ...
  ["/admin/procurement/receipt-log", { channel: "admin.receipt_log", match: "prefix", admin: true }],
  ...
  ["/admin/staff/roles", { channel: "admin.role_management", match: "exact", admin: true }],
  ...
  ["/admin/unworked-shifts", { channel: "admin.unworked_shifts", match: "prefix", admin: true }],
  ["/admin/yield-control", { channel: "admin.yield_control", match: "prefix", admin: true }],
  ...
  ["/investor", { channel: "investor_portal", match: "prefix", admin: true }],
